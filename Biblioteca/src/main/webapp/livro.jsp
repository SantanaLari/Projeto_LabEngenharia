		...
		<form action="livro" method="post">
			<div class="row">
				...
				<div class="input-group input-group-icon">
					<input type="text" placeholder="EM MANUTENÇÃO" name="AUSENTE"
						id="AUSENTE" />
				...
				<div class="input-group input-group-icon">
					<input type="text" placeholder="Caminho" name="caminho"
						id="caminho" />
					<div class="input-icon">
						<i class="fa fa-envelope"></i>
					</div>
				...
				<div class="input-group input-group-icon">
					<input type="text" placeholder="Disponibilidade"
						name="disponibilidade" id="disponibilidade" />
					<div class="input-icon">
						<i class="fa fa-envelope"></i>
					</div>
				</div>
