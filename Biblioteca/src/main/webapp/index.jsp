...
<body>
	...
	<div align="center">
		<form action="livro" method="get">
			<table>
				<tr>
					<td><input type="submit" name="botao" id="botao"
						value="Visualizar"></td>
				</tr>
			</table>
		</form>
				...
				<table class="table_round">
					...
					<tbody>
						<c:forEach items="${listaLivro }" var="livro">
							...
							<c:set var="cond" value="0" scope="page">
							</c:set>

							<c:forEach var="indisponivel" items="${listaIndisponivel }">
								<c:if
									test="${livro.disponibilidade == indisponivel.disponibilidade }">

									<c:set var="cond" value="2" scope="page">
									</c:set>
									<tr align="justify">
										...
										<td><form>
												<input type="submit" disabled="disabled" name="submit" value="Alocado">
											</form>
										</td>
									</tr>
								</c:if>
